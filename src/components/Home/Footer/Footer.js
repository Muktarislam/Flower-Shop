        ...
        <footer className="footer-area clear-both">
            <div className="container pt-5">
                <div className="row py-5">
                    <FooterCol style={{color:'black !'}} key={1} menuTitle="Our Community" menuItems={OurCommunity}/>
                ...
                <div style={{textAlign:'center', padding:"8px",marginBottom:'20px'}}>
                    ...
                    <button style={{backgroundColor:"pink", marginLeft:"10px"}}>JOIN US</button>
                </div>
                <div className="copyRight text-center">
                    <p style={{color:'white'}}>Copyright {(new Date()).getFullYear()} All Rights Reserved (M.A. MITHON)</p>
                </div>
            </div>
        </footer>
